...
PreparedStatement ps = db.getPS("select * from item where identity =?");
ps.setString(1, edit);
...
<div class="form-group">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" name="expirydate" id="expirydate" placeholder="Expiry Date" value="<%out.println(expiry);%>">
    </div>
  </div>
  <div class="form-group">
